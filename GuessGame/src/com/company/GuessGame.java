...
public class GuessGame {
    ...
    public void startGame() {
        ...
        System.out.println("Загадоно число");
        while (true) {
            ...
            guessp1 = p1.number;
            System.out.println("Первый игрок предлагает- " + guessp1);
            guessp2 = p2.number;
            System.out.println("Второй игрок предлагает- " + guessp2);
            guessp3 = p3.number;
            System.out.println("Третий игрок предлагает- " + guessp3);
